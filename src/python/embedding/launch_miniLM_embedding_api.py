# src/python/embedding/launch_miniLM_embedding_api.py
"""
paraphrase-multilingual-MiniLM-L12-v2 + FAISS）

- 用法:
    python src/python/embedding/launch_miniLM_embedding_api.py
...
# 直接導入所需函數，跳過依賴檢查
from embedding.build_miniLM_embedding_service import load_index, query_index
...
try:
    ...
    print("請先運行 build_miniLM_embedding_service.py --rebuild-index 創建索引")
    sys.exit(1)
